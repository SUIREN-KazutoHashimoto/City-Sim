...
interface ActionDef {
  readonly name: string; readonly category: POICategory;
...
const ACTIONS: ActionDef[] = [
  {
    ...
    score: (s, i, clock) => {
      const occ = s.occupation[i] as Occupation; const h = clock.hourF;
      let sleepy: number;
  ...
  },
  {
    ...
    score: (s, i, clock) => {
      ...
      if (!isWorkTime(occ, s.workStart[i], s.workEnd[i], clock.hourF)) return 0;
  ...
  },
  {
    ...
    score: (s, i, clock) => {
      ...
      if (isWorkTime(occ, s.workStart[i], s.workEnd[i], h)) return 0.05;
  ...
  },
  {
    ...
    score: (s, i, clock) => {
      const h = clock.hourF; const occ = s.occupation[i] as Occupation;
