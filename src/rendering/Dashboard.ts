...
export class Dashboard {
  ...
  constructor(private world: World, private clock: SimulationClock) {
    ...
    this.canvas = document.createElement('canvas'); this.canvas.width = 304; this.canvas.height = 96; this.canvas.style.cssText = 'width:304px;height:96px;display:block;border-radius:4px'; this.root.appendChild(this.canvas); this.ctx = this.canvas.getContext('2d')!;
